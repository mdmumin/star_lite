                ...
                >
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="ps-3 d-flex gap-2">
                            <router-link :to="{ name: 'aboutCreate' }" class="router-link-active btn btn-info btn-sm">
                                Create
                            </router-link>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <tbody>
                                <tr v-for="item in data?.data" :key="item.id">
                                    ...
                                    <td>
                                        <img
                                            :src="getImageUrl(item.video_thumbnail_image)"
                                            alt="Cover Image"
                                            class="img-thumbnail"
                                            style="max-width: 100px"
                                        />
...
export default {
    ...
    methods: {
        delet_data: async function (id) {
            ...
            if (con) {
                await axios.post("/api/v1/about/destroy", { id: id });
                alert("Deleted");
                this.get_all_data();
            }
        },
        get_all_data: async function (url = null) {
            ...
            try {
                if (url) {
                    ...
                    res = await axios.get("/api/v1/about/all");
                }
