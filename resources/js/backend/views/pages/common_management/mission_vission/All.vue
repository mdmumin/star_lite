                ...
                >
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="ps-3 d-flex gap-2">
                            <router-link :to="{ name: 'missionVissionCreate' }" class="router-link-active btn btn-info btn-sm">
                                Create
                            </router-link>
                        </div>
                    </div>
                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th class="" style="width: 300px">Type</th>
...
export default {
    ...
    methods: {
        delet_data: async function (id) {
            ...
            if (con) {
                await axios.post("/api/v1/mission/vission/destroy", { id: id });
                alert("Deleted");
                this.get_all_data();
            }
        },
        get_all_data: async function (url = null) {
            ...
            try {
                if (url) {
                    ...
                    res = await axios.get("/api/v1/mission/vission/all");
                }
