                ...
                >
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="ps-3 d-flex gap-2">
                            <router-link :to="{ name: 'testimonialCreate' }" class="router-link-active btn btn-info btn-sm">
                                Create
                            </router-link>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        delet_data: async function (id) {
            ...
            if (con) {
                await axios.post("/api/v1/testimonial/destroy", { id: id });
                alert("Deleted");
                this.get_all_data();
            }
        },
        get_all_data: async function (url = null) {
            ...
            try {
                if (url) {
                    ...
                    res = await axios.get("/api/v1/testimonial/all");
                }
