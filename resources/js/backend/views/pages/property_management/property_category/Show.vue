    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header py-3 position-sticky d-flex justify-content-between align-items-center">
                <h6>Property Category Details</h6>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Image</th>
                                <td>
                                    <img v-if="propertyCategory.image" :src="propertyCategory.image" alt="Cover Image" class="img-thumbnail" style="max-width: 150px;">
...
export default {
    ...
    methods: {
        getBlogDetails: async function() {
            try {
                let response = await axios.get(`/api/v1/property/category/${this.$route.params.id}`);
