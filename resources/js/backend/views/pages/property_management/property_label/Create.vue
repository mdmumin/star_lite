            ...
            <div class="card">
                <div>
                    ...
                    >
                        ...
                        <router-link :to="{ name: 'propertyLabelAll' }" class="router-link-active btn btn-info btn-sm">Back</router-link>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
...
export default {
    ...
    methods:{
        from_submit: async function(){
            ...
            try {
                await axios.post('/api/v1/property/label/store', from_data);
                alert("Property Tag Created Successfully!");
                target.reset();                
            } 
            catch (error) {
                console.error("Error:", error.response);
                alert("Failed to create property tag. Check console for details.");
            }
        },
    }
};
