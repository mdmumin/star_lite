                ...
                >
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="ps-3 d-flex gap-2">
                            <router-link :to="{ name: 'blogCommentCreate' }" class="router-link-active btn btn-info btn-sm">Create</router-link>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th class="" style="width: 200px">User Id</th>
                                    <th class="" style="width: 300px">Blog Id</th>
                                    <th class="" style="width: 200px">Total Count</th>                                                                       
                            ...
                            <tbody>
                                <tr v-for="item in data?.data" :key="item.id">
                                    ...
                                    <td class="">{{ getShortTitle(item.blog.title) }}</td>
                                    <td class="">{{ getShortTitle(item.comment) }}</td>
...
export default {
    ...
    methods: {
        delet_data: async function (id) {
            ...
            if (con) {
                await axios.post("/api/v1/blog/comment/destroy", { id: id });
                alert("Deleted");
                this.get_all_data();
            }
        },
        get_all_data: async function (url = null) {
            ...
            try {
                if (url) {
                    ...
                    res = await axios.get("/api/v1/blog/comment/all");
                }
