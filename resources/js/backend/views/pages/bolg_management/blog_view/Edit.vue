                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-1 mb-3">
                                    <textarea v-model="form.comment" class="form-control" type="text" name="comment" >
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    methods: {
        ...
        from_submit: async function(){
            try {
                ...
                await axios.post('/api/v1/blog/comment/update', from_data);
        ...
        get_data: async function () {
            try {
                let res = await axios.get('/api/v1/blog/comment/' + this.$route.params.id);
