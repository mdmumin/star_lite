    ...
    <div>
        <div class="card rounded-none">
            <div class="card-header pt-3 pb-1 d-flex justify-content-between align-items-center">
                <div><h4 class="bn" style="font-size: 22px !important;">All Blog Tag</h4></div>
                            ...
                            <tr v-for="item in data" ::key="item.id">
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-3">
                                        <router-link :to="{ name: 'blogTagEdit', params: { id: item.id } }" class="btn btn-sm btn-outline-info">
                                         Edit 
                                         </router-link>
                                         <router-link :to="{ name: 'blogTagShow', params: { id: item.id } }" class="btn btn-sm btn-outline-success">
                                         Show
                                         </router-link>
...
export default {
    ...
    methods: {
        delet_data: async function(id){
            ...
            if(con){
                await axios.post('/api/v1/blog/tag/destroy', {id: id});
                alert('Deleted');
                this.get_all_data();
            }
        },
