<template lang="">
    ...
    >
        <div class="logo-wrapper">
            <a
                href="http://admin.pixelstrap.com/universal/default/index.html"
            >
                <img
                    src="/backend/assets/logo-light.png"
                    class="image-dark"
                    alt=""
                />
                <img
                    src="/backend/assets/logo-light-dark-layout.png"
                    class="image-light"
                    alt=""
                />
            </a>
                ...
                <li>
                    ...
                    >
                        <img
                            ...
                            src="/backend/assets/browser.png"
                            alt="header-browser"
                        />
                    </a>
                </li>
